...
set(CMAKE_ASM_FLAGS "-march=${RISCV_ARCH} -mabi=${RISCV_ABI}")
set(CMAKE_C_FLAGS "${CMAKE_ASM_FLAGS} -ffreestanding -march=${RISCV_ARCH} -mabi=${RISCV_ABI} -mcmodel=${RISCV_CMODEL} -fno-stack-protector")

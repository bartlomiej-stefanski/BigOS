...
[[nodiscard]] size_or_err_t pipe_read(KernelReadPipe_t* read_end, pstring_t* buff);
[[nodiscard]] size_or_err_t pipe_write(KernelWritePipe_t* write_end, const pstring_t* data);
